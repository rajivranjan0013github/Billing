import { ChevronRight, ClipboardX, ChevronLeft, ChevronLeftIcon, ChevronRightIcon, Loader2 } from 'lucide-react'
...
export default function Timeline({inventoryId}) {
    ...
    useEffect(() => {
        const fetchTimeline = async () => {
            setLoading(true);
            try {
                const response = await fetch(`${Backend_URL}/api/inventory/timeline/${inventoryId}?type=all&page=${currentPage}`, {credentials: "include"});
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-500">
            {loading ? (
              <>
                ...
                <p className="text-sm font-medium mt-4">Loading transactions...</p>
              </>
            ) : (
              <>
