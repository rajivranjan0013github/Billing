...
import { Backend_URL, convertToFraction } from "../../../assets/Data"
                    ...
                    <tbody>
                        {purchases.map((purchase, index) => (
                            ...
                            >
                                ...
                                <td className="px-4 py-2 text-right">
                                    <div className="text-sm font-medium">{purchase.credit} packs</div>
                                    {purchase.remarks && (
                                        <div className="text-xs text-gray-500">{purchase.remarks}</div>
                                    )}
                                </td>
                                <td className="px-4 py-2">
