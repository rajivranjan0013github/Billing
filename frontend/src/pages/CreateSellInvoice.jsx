...
const DiscountInputs = ({
  ...
  <div className="flex items-center gap-2">
    <div className="flex items-center">
      <span className="bg-gray-100 border border-r-0 border-gray-200 rounded-l h-7 w-8 text-sm flex items-center justify-center">
        %
      </span>
      <Input
        type="number"
...
const CreateSellInvoice = () => {
  ...
  useEffect(() => {
    const fetchNextInvoiceNumber = async () => {
      try {
        const response = await fetch(`${Backend_URL}/api/bills/next-invoice-number`, {
          credentials: 'include'
        });
          ...
          <div className=" col-span-2">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  <Checkbox
                    ...
                    onCheckedChange={handleCashCustomerChange}
                  />
                  <label
                    htmlFor="cash-customer"
            ...
            <div className="p-4">
              {selectedParty ? (
                ...
                <div
                  onClick={() => setShowPartyDialog(true)}
                  className={`cursor-pointer p-6 border border-dashed border-gray-200 rounded-md ${
                    selectedParty ? "w-96" : "w-40"
                  }`}
                >
          ...
          <div className=" p-4">
            <div className="flex gap-2">
              ...
              <div>
                ...
                <Input type="date" placeholder="000000" />
              </div>
            </div>
          </div>
        </div>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-gray-200 p-2 text-left text-sm w-12">
                    No.
                  </th>
                  <th className="border border-gray-200 p-2 text-left text-sm w-48">
                    Item Name
                  </th>
                  <th className="border border-gray-200 p-2 text-left text-sm w-24">
                    HSN
                  </th>
                  <th className="border border-gray-200 p-2 text-left text-sm w-24">
                    Batch No
                  ...
                  <th className="border border-gray-200 p-2 text-left text-sm w-20">
                    Qty
                  </th>
                  <th className="border border-gray-200 p-2 text-left text-sm w-28">
                    Rate(₹)
                  </th>
                  <th className="border border-gray-200 p-2 text-left text-sm w-28">
                    Amount(₹)
                  ...
                  <tr key={item.id} className="hover:bg-gray-50">
                    ...
                    <td className="border border-gray-200 p-2 text-sm">
                      <div className="flex flex-col gap-1">
                        <div className="flex items-center">
                          <span className="bg-gray-100 border border-r-0 border-gray-200 rounded-l h-6 w-8 text-sm text-center">
                            %
                          </span>
                          <Input
                            type="number"
              ...
              <tfoot>
                <tr className="bg-gray-50">
                  ...
                  <td
                    colSpan={0}
                    className="border border-gray-200 px-4 py-2 text-sm font-semibold text-right"
                  >
                    ₹
                  ...
                  <td className="border border-gray-200 px-4 py-2 text-sm font-semibold text-right">
                    ₹
                    {calculateTotals().discount.toLocaleString("en-IN", {
                      minimumFractionDigits: 2,
                    })}
                  </td>
                  <td className="border border-gray-200 px-4 py-2 text-sm font-semibold text-right">
                    ₹
                    {calculateTotals().tax.toLocaleString("en-IN", {
                      minimumFractionDigits: 2,
                    })}
                  </td>
                  <td
        ...
        <table className=" text-sm w-1/2 m-4">
          ...
          <tbody>
            {calculateTaxSummary().map((group) => (
              <tr key={group.rate} className="border-b border-gray-200">
                ...
                <td className="py-2 text-right">
                  ₹{group.taxableAmount.toLocaleString("en-IN", {
                    minimumFractionDigits: 2,
                  })}
                </td>
                <td className="py-2 text-right">
                  ₹{group.sgst.toLocaleString("en-IN", {
                    minimumFractionDigits: 2,
                  })}
                </td>
                <td className="py-2 text-right">
                  ₹{group.cgst.toLocaleString("en-IN", {
                    minimumFractionDigits: 2,
                  })}
                </td>
              </tr>
            ...
            <tr className="font-medium">
              ...
              <td className="py-2 text-right">
                ₹{(calculateTotals().tax / 2).toLocaleString("en-IN", {
                  minimumFractionDigits: 2,
                })}
              </td>
              <td className="py-2 text-right">
            ...
            <div className="w-full py-4">
              ...
              <div className="px-8 flex flex-col gap-2 border-t border-gray-200 pt-2 mt-2">
                ...
                <div className="flex justify-between items-center font-semibold">
                  ...
                  <span>
                    ₹
                    {(isRoundOff
                      ? getRoundedTotal(calculateTotals().total)
              ...
              <div className="px-8 flex flex-col gap-2 border-t border-gray-200 pt-2 mt-2">
                <div className="flex items-center gap-2 self-end">
                  <Checkbox
                    checked={isFullyPaid}
                    onCheckedChange={handleFullyPaidChange}
                    id="fully-paid"
                  />
                  <label
                    htmlFor="fully-paid"
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex items-center">
                      <span className="bg-gray-100 border border-r-0 border-gray-200 rounded-l h-8 w-8 text-sm flex items-center justify-center">
                        ₹
                      </span>
                      <Input
                        type="number"
