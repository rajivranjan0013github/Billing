            ...
            <div className="col-span-3  border-l border-gray-800">
              ...
              <div className="text-xs font-medium p-2">
                <div className="grid grid-cols-3">
                  ...
                  <span className="col-span-2 capitalize">{invoiceData.distributorName}</span>
                </div>
                <div className="grid grid-cols-3">
                  <span className="">Mob No:</span>
                  <span className="col-span-2">{9097849090}</span>
                </div>
                <div className="grid grid-cols-3">
                  <span className="">Address:</span>
                  <span className="col-span-2">{'Gaya, Bihar'}</span>
                </div>
                <div className="grid grid-cols-3">
                  <span className="">Doctor:</span>
                  <span className="col-span-2">{'Dr. Rajiv Ranjan'}</span>
                </div>
              </div>
            </div>
          </div>
